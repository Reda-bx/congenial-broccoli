...
/***/ function(module, exports, __webpack_require__) {
	...
	t.list('id').then(function (result) {
	  ...
	  return _axios2.default.get('https://hf-automator.herokuapp.com/lists/' + id);
	}).then(function (res) {
	  var data = res.data;
	  ...
	  var options = (0, _map2.default)(data.checklist.items, 'subject');
	...
	document.getElementById('subjects').onchange = function (e) {
	  ...
	  var email = globalList.checklist.items.find(function (item) {
